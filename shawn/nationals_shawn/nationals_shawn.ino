...
const long ENC_SIDE1_SLOW_COUNT  = 650;   // ticks before slowing down on Side 1
const long ENC_SIDE1_STOP_COUNT  = 780;  // ticks to stop on Side 1
const long ENC_SIDE3_SLOW_COUNT  = 650;   // ticks before slowing down on Side 3
const long ENC_SIDE3_STOP_COUNT  = 780;   // ticks to stop on Side 3
