...
void runRectangleLap() {
  ...
  executeDriveUntilCloseSpeed(0.0, STOP_DISTANCE_CM, true, true, FWD_BASE_SPEED_2);
  waitMs(pause_ms);
...
void runRectangleLapFromSide3() {
  ...
  executeDriveUntilCloseSpeed(0.0 - offset2, STOP_DISTANCE_CM, true, true, FWD_BASE_SPEED_2);
  waitMs(pause_ms);
