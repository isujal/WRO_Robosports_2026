...
const unsigned long PHASE2_DURATION_MS = 106000; // was 35000 — phase 2 ends here
const unsigned long PHASE3_START_MS    = 115000; // ← ADD — phase 3 doesn't begin until here
...
void runRectangleLap2() {
  ...
  executeDrive(750, 0.0);    //// sohum store
  waitMs(pause_ms);
  servoWrite(SERVO_SHOOT);
