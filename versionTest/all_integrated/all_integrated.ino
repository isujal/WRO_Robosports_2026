...
void setup() {
  ...
  Serial.println("IMU ready. Starting rectangle in 2 seconds...");
  delay(2000);

  // ---- Intake ON — full trajectory ----
  intakeOn();
  Serial.println("Intake ON");

  // ---- Servo at 90° — holds during trajectory ----
  ...
  Serial.println("=== SIDE 1: Forward 900ms @ 0deg ===");
  executeDrive(1500, 0.0);
  pause(1000);

  // ---- Shoot after Side 1, before Turn 1 ----
  Serial.println("=== SHOOTER: 135deg → 300ms → 90deg ===");
  servoShoot();
  pause(500);
  ...
  Serial.println("=== SIDE 2: Forward 500ms @ 90deg ===");
  executeDrive(1500, 90.0);
  pause(1000);
  ...
  Serial.println("=== SIDE 3: Forward 900ms @ 180deg ===");
  executeDrive(1500, 180.0);
  pause(1000);
  ...
  Serial.println("=== SIDE 4: Forward 500ms @ -90deg ===");
  executeDrive(1500, -90.0);
  pause(1000);
