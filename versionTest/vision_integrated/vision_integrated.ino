...
void runTrajectory3() {
  ...
  executeDrive(T3_PHASE1_MS, 20.0);
  ...
  executeDrive(T3_PHASE2_MS, 20.0);
  ...
  executeDrive(T3_PHASE3_MS, 20.0);
...
void runTrajectory4() {
  ...
  executeDrive(T4_PHASE1_MS, 20.0);
  ...
  executeDrive(T4_PHASE2_MS, 20.0);
